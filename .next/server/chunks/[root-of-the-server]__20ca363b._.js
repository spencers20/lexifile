...
([__TURBOPACK__imported__module__$5b$externals$5d2f$formidable__$5b$external$5d$__$28$formidable$2c$__esm_import$29$__, __TURBOPACK__imported__module__$5b$externals$5d2f$langchain$2f$text_splitter__$5b$external$5d$__$28$langchain$2f$text_splitter$2c$__esm_import$29$__, __TURBOPACK__imported__module__$5b$externals$5d2f$langchain$2f$document__$5b$external$5d$__$28$langchain$2f$document$2c$__esm_import$29$__, __TURBOPACK__imported__module__$5b$externals$5d2f40$vercel$2f$blob__$5b$external$5d$__$2840$vercel$2f$blob$2c$__esm_import$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__);
;
;
;
;
        ...
        try {
            ...
            if (ext == 'csv') {
                try {
                    ...
                    const blob = await (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$vercel$2f$blob__$5b$external$5d$__$2840$vercel$2f$blob$2c$__esm_import$29$__["put"])(filename, buffer, {
                        access: 'public',
                        addRandomSuffix: true,
                        token: process.env.BLOB_R_W_TOKEN_READ_WRITE_TOKEN
                    });
                    const file_path = blob.url;
                    res.setHeader('Set-Cookie', (0, __TURBOPACK__imported__module__$5b$externals$5d2f$cookie__$5b$external$5d$__$28$cookie$2c$__cjs$29$__["serialize"])("file_path", file_path, {
                        path: '/',
                        httpOnly: true,
                        sameSite: 'lax'
                    }));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__20ca363b._.js.map